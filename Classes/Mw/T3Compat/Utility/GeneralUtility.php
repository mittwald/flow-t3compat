...
class GeneralUtility {
	...
	static public function png_to_gif_by_imagemagick($theFile) {
        throw new \Mw\T3Compat\Exception\IncompatibilityException(__FUNCTION__ . ' is not supported.');
	}
...
';
	...
	static public function rmdir($path, $removeNonEmpty = FALSE) {
        ...
        else \TYPO3\Flow\Utility\Files::removeEmptyDirectoriesOnPath($path);
	}
	...
	static public function initSysLog() {
		...
		if (defined('TYPO3_cliMode') && TYPO3_cliMode) {
			$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_div.php']['systemLogHost'] = self::getHostname(($requestHost = FALSE)) . ':' . FLOW_PATH_ROOT;
		} else {
